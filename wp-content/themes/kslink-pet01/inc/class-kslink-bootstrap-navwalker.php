...
if ( ! class_exists( 'Kslink_Bootstrap_Navwalker' ) ) {
	/**
	 * Kslink_Bootstrap_Navwalker class.
	 *
	 * @extends Walker_Nav_Menu
	 */
	class Kslink_Bootstrap_Navwalker extends Walker_Nav_Menu {
